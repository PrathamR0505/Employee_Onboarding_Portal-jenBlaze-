    ...
    <Layout>
      <div style={{ 
        ...
        <div style={{ textAlign: 'center', marginBottom: '3rem' }}>
          ...
          <h1 style={{ fontSize: '2.5rem', fontWeight: 800, color: '#404E3B', marginBottom: '0.75rem', letterSpacing: '-0.02em' }}>Create HR Account</h1>
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div style={{ marginBottom: '1.5rem' }}>
                  ...
                  <input 
                    ...
                    required 
                    style={{ width: '100%', padding: '1rem 1.25rem', borderRadius: '14px', border: '2px solid #f3f4f6', background: '#E6E6E6', fontSize: '1.05rem', color: '#404E3B', outline: 'none', transition: 'all 0.2s ease', boxSizing: 'border-box', fontFamily: 'inherit', letterSpacing: password ? '2px' : 'normal' }}
                    onFocus={(e) => { e.target.style.borderColor = '#c4b5fd'; e.target.style.background = '#ffffff'; e.target.style.boxShadow = '0 0 0 4px rgba(139, 92, 246, 0.1)'; }}
                    onBlur={(e) => { e.target.style.borderColor = '#f3f4f6'; e.target.style.background = '#E6E6E6'; e.target.style.boxShadow = 'none'; }}
                  />
                </div>
                <div style={{ marginBottom: '2.5rem' }}>
                  ...
                  <input 
                    ...
                    required 
                    style={{ width: '100%', padding: '1rem 1.25rem', borderRadius: '14px', border: '2px solid #f3f4f6', background: '#E6E6E6', fontSize: '1.05rem', color: '#404E3B', outline: 'none', transition: 'all 0.2s ease', boxSizing: 'border-box', fontFamily: 'inherit', letterSpacing: confirm ? '2px' : 'normal' }}
                    onFocus={(e) => { e.target.style.borderColor = '#c4b5fd'; e.target.style.background = '#ffffff'; e.target.style.boxShadow = '0 0 0 4px rgba(139, 92, 246, 0.1)'; }}
                    onBlur={(e) => { e.target.style.borderColor = '#f3f4f6'; e.target.style.background = '#E6E6E6'; e.target.style.boxShadow = 'none'; }}
                  />
                </div>
